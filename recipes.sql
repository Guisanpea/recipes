...
CREATE TABLE IF NOT EXISTS `recipies`.`Recipe` (
  ...
  INDEX `fk_Recipe_Level1_idx` (`levelId` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `recipies`.`RecipeHasIngredient` (
  ...
  INDEX `fk_Recipe_has_Ingredient_Recipe_idx` (`recipeId` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `recipies`.`User` (
  ...
  PRIMARY KEY (`id`),
  INDEX `fk_User_Experience1_idx` (`experienceId` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `recipies`.`RecipeHasCategory` (
  ...
  INDEX `fk_Recipe_has_Category_Category1_idx` (`categoryId` ASC) VISIBLE,
  INDEX `fk_Recipe_has_Category_Recipe1_idx` (`recipeId` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `recipies`.`UserHasRecipe` (
  ...
  INDEX `fk_User_has_Recipe_Recipe1_idx` (`recipeId` ASC) VISIBLE,
  INDEX `fk_User_has_Recipe_User1_idx` (`userId` ASC) VISIBLE,
